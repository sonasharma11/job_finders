...
if (isset($_POST['save'])) {
  ...
  $query = "INSERT INTO job (job_title, company, location, job_description, status, recruiter_id)
            VALUES ('$job_title', '$company', '$location', '$job_description', 'active', '$recruiter_id')";
  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      <nav id="sidebarMenu" class="col-lg-2 col-md-3 collapse d-lg-block sidebar">
        ...
        <a href="rec_dashboard.php" class="active"><i class="fa-solid fa-plus me-2"></i>Post New Job</a>
